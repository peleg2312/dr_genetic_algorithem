      ...
      child: Container(
        ...
        child: ListView(
          children: [
            ...
            myAppointment==null?const Center(child: Text("there are no appointment yet"),):AppointmentCard(context,myAppointment!),
            SizedBox(
              height: height*0.5,
            ),         
...
class AppointmentButton extends StatelessWidget{
    ...
    return Center(
      child: InkWell(
        ...
        child: Container(
            ...
            height: height * 0.1,
            child: const Center(
              child: Text("Order Appointment",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w600),),
            ),
  ...
  void _showDialog(BuildContext context,TextEditingController doctorNameController,TextEditingController healnaseController,TextEditingController dateController,TextEditingController timeController) {
    showDialog(
        context: context,
        builder: ((context) {
          return AlertDialog(
              ...
              TextButton(
                  onPressed: (() {
                    ...
                    if (doctorNameController.text == null ||
                        ...
                        healnaseController.text == "" || dateController.text == null ||
                        dateController.text.isEmpty ||
                        dateController.text == "" || timeController.text == null ||
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(DateTime(DateTime.now().year, DateTime.now().month,
                    DateTime.now().day)
                .toString()
                .substring(0, 10))
          ],
